    ...
    templates.push(
      {
        ...
        defaultValue: "GTManager Desktop",
      },
      {
        key: "SUBFOLDER",
  ...
  const renderTypeIcon = (typeId: string) => {
    if (typeId === "openclaw") {
      return (
        <img
          src="/openclaw.png"
          alt={getInstanceTypeLabel(t, "openclaw", "GTClaw Desktop")}
          ...
          {step === 2 && (
            <div className="app-panel p-6">
              ...
              <div className="mt-6 rounded-[24px] border border-[#ead8cf] bg-[rgba(255,248,245,0.72)] p-5">
                <div>
                  <h3 className="text-sm font-semibold uppercase tracking-[0.18em] text-[#2563eb]">
                    ...
                    {runtimeImageOptions.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className={`rounded-[20px] border p-4 text-left transition-all hover:-translate-y-0.5 hover:shadow-[0_24px_56px_-42px_rgba(30,64,175,0.55)] ${
                            selected
                        ...
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              ...
                              <p className="mt-1 text-xs uppercase tracking-[0.16em] text-[#2563eb]">
                ...
                <div className="app-panel order-1 p-6">
                  ...
                  <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    {Object.entries(PRESET_CONFIGS).map(([key, config]) => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex h-[188px] flex-col justify-between rounded-[22px] border p-4 text-left transition-all hover:-translate-y-0.5 hover:shadow-[0_24px_56px_-42px_rgba(30,64,175,0.55)] ${
                            selected
                              ? "border-indigo-500 ring-2 ring-indigo-500"
                              : "border-gray-300"
                          }`}
                    ...
                    <div
                      ...
                      className={`flex h-[188px] flex-col justify-between overflow-hidden rounded-[22px] border p-4 text-left transition-all hover:-translate-y-0.5 hover:shadow-[0_24px_56px_-42px_rgba(30,64,175,0.55)] ${
                  ...
                  <div className="app-panel order-2 p-6">
                    ...
                    {openClawInjectionMode === "manual" && (
                      <div className="mt-6 border-t border-gray-200 pt-6">
                        <div className="flex items-start justify-between gap-4">
                          <div>
                            <h3 className="text-xs font-semibold uppercase tracking-[0.18em] text-[#2563eb]">
